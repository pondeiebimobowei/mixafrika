...
export default function CollectionCard({collection, onClick}: {collection: ICollection, onClick: () => void}){
    return (
        <div 
      onClick={onClick}
    ...
    >
      <div className="p-6">
        ...
        <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-primary transition-colors">{collection.name}</h3>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-green-50 rounded-xl p-3">
              ...
              <div className="flex items-center gap-1">
                  ...
                  <span className="text-lg font-bold text-green-700">{collection.roi}%</span>
              </div>
          </div>
          <div className="bg-gray-50 rounded-xl p-3">
              <p className="text-xs text-gray-600 font-medium mb-1">Min Entry</p>
              <span className="text-lg font-bold text-gray-900">₦{collection.min_investment}</span>
          </div>
        </div>
        ...
        {/* <div className="space-y-2">
          ...
          <div className="flex justify-between text-xs text-gray-400">
              ...
              <span>Target: ₦{collection.target.toLocaleString()}</span>
          </div>
        </div> */}
      </div>
    </div>
