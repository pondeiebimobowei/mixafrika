              ...
              {[1,2,3].map((item, idx)=> (
                <View key={idx} className='flex flex-row items-center justify-between'>
                  ...
                  <View className='w-9/12'>
                    <Text className='dark:text-white font-semibold text-md'>Tips for managing your daily cash flow</Text>
                    <Text className='text-slate-600 dark:text-slate-300'>Financial Tips</Text>
                  </View>
