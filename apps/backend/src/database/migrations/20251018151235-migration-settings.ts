  ...
  async up(queryInterface: QueryInterface, Sequelize: typeof DataTypes) {
    await queryInterface.sequelize.transaction( async(t) =>{
      await queryInterface.createTable('setting', {
        ...
        enable_dark_mode: { type: Sequelize.BOOLEAN, allowNull: false, defaultValue: false },
        enable_email_notification: { type: Sequelize.BOOLEAN, allowNull: false, defaultValue: false },
        enable_push_notification: { type: Sequelize.BOOLEAN, allowNull: false, defaultValue: false },
