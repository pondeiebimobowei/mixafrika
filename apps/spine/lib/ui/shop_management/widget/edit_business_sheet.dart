...
class _EditBusinessSheetState extends ConsumerState<EditBusinessSheet> {
  ...
  void initState() {
    ...
    _addressController =
        TextEditingController(text: widget.business?.streetAddress ?? '');
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildFormSection(context, 'BUSINESS IDENTITY', [
                _buildLabel('BUSINESS NAME'),
                const SizedBox(height: 10),
                _buildTextField(
                  controller: _nameController,
                  hint: 'e.g. Mix Africa Ltd',
              ...
              SizedBox(
                ...
                child: FButton(
                  child: Text(isEditing ? 'Save Changes' : 'Create Business'),
                  onPress: () {
