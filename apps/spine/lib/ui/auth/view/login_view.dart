...
class LoginView extends ConsumerWidget {
  ...
  final FColors colors = context.theme.colors;
    ...
    return Scaffold(
      body: SafeArea(child: loginState.when(
        data: (data) {
                      ...
                      SizedBox(
                        ...
                        child: FButton(
                          ...
                          onPress: () async {
                            ...
                            final res = await ref.read(loginViewModelProvider.notifier).login(email: _emailController.text, password: _passwordController.text);
                            if(res.success){
                              print(res.message);
                              context.go('/');
                            }
